...
// * better then empty() which considers "0" to be empty
...
// * use trim() if spaces shoud not count
...
// * validate string length
// * combine functions _greater_than, _less_than, _exactly
// * spaces count towards length
// * use trim() if spaces should not count
...
// * preg_match is helpfull. uses a regular expression
...
// * For existing records provide current ID as a second argument
